...
(function() {
  ...
  function advanceTimer() {
    ...
    // Reduce remaining time by 1 seconds
    remainingSeconds --;
    
    /**
     * Make string and set to time id as : id("time").textContent = "05:00";
     * Take out minutes and seconds and create string out of it
     **/
    let remainingMinutes = Math.floor(remainingSeconds / ONE_MINUTE);
    let remainingSec = remainingSeconds % ONE_MINUTE;
    let timeString = remainingMinutes.toString().padStart(2,'0') + ':' + 
                 remainingSec.toString().padStart(2,'0') ;

    // Setting time component in index.html to this new string

    id("time").textContent = timeString;
